...
//)
//
//const MysqlConfig = "root:123456@(localhost:3306)/student?charset=utf8mb4&parseTime=True&loc=Local"
//
//func createModel() {
...
//	})
//
//	autoUpdateTimeField := gen.FieldComment("update_time", "column:update_time;type:int unsigned;autoUpdateTime")
//	autoCreateTimeField := gen.FieldComment("create_time", "column:create_time;type:int unsigned;autoCreateTime")
